...
class VAQIndex:
    ...
    def _init_boundaries(self):
        ...
        for block in tp_gene:
            ...
            # Set first boundary_val (0) along current dimension to min(block) - 0.001; just less than min value along dimension
            # N.B. self.boundary_vals is (max(self.cells) + 1, num_dimensions). +1 as there are k+1 boundary values for k cells.
            ...
            for j in range(1, cells_for_dim):
                ...
                self.boundary_vals[j, block_count] = sorted_block[math.ceil(j*self.TDS.DS.num_vectors / cells_for_dim)]
